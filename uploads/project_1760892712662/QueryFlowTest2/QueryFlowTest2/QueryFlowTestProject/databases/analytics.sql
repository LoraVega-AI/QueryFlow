-- Analytics Database Schema for QueryFlow Testing
-- This database contains complex analytics tables for testing advanced features
...
-- User Sessions Table (Additional for complex relationships)
